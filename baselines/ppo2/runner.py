...
class Runner(AbstractEnvRunner):
    ...
    def run(self):
        ...
        from block_collab_py.mdp.actions import Action
        ...
        for _ in range(self.nsteps):
            ...
            overcooked = 'env_name' in self.env.__dict__.keys() and self.env.env_name == "BlockCollab-v0"
            # if overcooked:
            ...
            self.curr_state = obs["blockcollab_state"]
